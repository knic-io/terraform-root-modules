...
module "organization_access_group_ssm_prod" {
  ...
  parameter_write = [
    ...
    {
      name        = "/${var.namespace}/prod/kubernetes_admin_group"
      value       = "${module.kops_admin_access_group_prod.group_name}"
      type        = "String"
      overwrite   = "true"
      description = "IAM kubernetes admin group name for the 'prod' account"
    },
    {
      name        = "/${var.namespace}/prod/kubernetes_readonly_group"
      value       = "${module.kops_readonly_access_group_prod.group_name}"
      type        = "String"
      overwrite   = "true"
      description = "IAM kubernetes readonly group name for the 'prod' account"
    },
  ]
}
